...
public class SolverTest
{
    ...
    Cell[,] grid13x13 = new Cell[,]
    {
        ...
        {new BlackCell(),new SumCell(-1,16),new SumCell(-1,21),new BlackCell(),new SumCell(11,-1),new WhiteCell(),new WhiteCell(),new SumCell(-1,28),new BlackCell(),new SumCell(-1,29),new SumCell(-1,17),new BlackCell(),new BlackCell()},
